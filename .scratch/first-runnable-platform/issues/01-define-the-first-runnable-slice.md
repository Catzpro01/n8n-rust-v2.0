...
2. The canvas contains six built-in Native Nodes: Manual Trigger, Generate Range, Transform, If/Route, Aggregate, and Output Digest.
...
7. Output Digest returns count, branch counts, deterministic content hash, elapsed wall and CPU time, and resource evidence.
